...
if (($_POST['action'] ?? '') === 'save_question') {
  ...
  $choicesCount = normalize_int($_POST['choices_count'] ?? 4, 2, 10);
      ...
      <section class="cardx" style="margin-top:12px;">
        ...
        <form method="post" class="aq-form" enctype="multipart/form-data" autocomplete="off" id="qForm">
          ...
          <label class="field">
            ...
            <input class="input2" type="number" min="2" max="10" step="1" name="choices_count" id="choicesCount" required value="<?php echo (int)$cc; ?>">
          </label>
  ...
  <script>
    (function () {
      ...
      function buildChoices() {
        ...
        const count = choicesCount ? parseInt(choicesCount.value || '4', 10) : 4;
